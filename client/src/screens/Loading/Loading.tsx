...
export const Loading = () => {
  ...
  return (
    <motion.div id="loading" variants={wrapperVariant} initial="initial" animate="animate">
      ...
      <motion.div className="color fourth" variants={loadingVariant}></motion.div>
      <motion.div className="logo" variants={{}}>
        <motion.div className="logo-wrapper" variants={logoVariant}>
          <motion.svg
            ...
            variants={{}}
          >
            <motion.circle cx="41.5" cy="41.5" r="38.5" stroke="#FF0B56" stroke-width="6" />
          </motion.svg>
          <motion.svg
            width="38"
            height="37"
      ...
      <motion.div className="color curtain" variants={curtainVarient}></motion.div>
    </motion.div>
  );
};
