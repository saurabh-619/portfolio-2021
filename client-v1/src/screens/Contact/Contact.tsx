        ...
        >
          ...
          <motion.div className="center" transition={staggerTransition(0.6)}>
            <motion.p className="font-h430-R" variants={fadeUpAnimationNew()}>
              I’m open to your ideas. I’m also interested in freelance
              opportunities. Let’s get connected and build something together!
            </motion.p>
            <motion.div
          ...
          <motion.div
            className="footer font-caption13-M"
            variants={fadeUpAnimationNew()}
            ref={ref}
          >
            <p>
              Designed and Developed by Saurabh Bomble @{" "}
